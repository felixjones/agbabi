 ...
 * @return quotient
 */
long long __aeabi_ldiv(long long numerator, long long denominator) __attribute__((const));
 ...
 * @return quotient
 */
unsigned long long __aeabi_uldiv(unsigned long long numerator, unsigned long long denominator) __attribute__((const));
