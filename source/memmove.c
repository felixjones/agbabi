...
void __aeabi_memmove4( void * dest, const void * src, size_t n ) __attribute__((section(".ewram"))) __attribute__((target("thumb")));
void __aeabi_memmove( void * dest, const void * src, size_t n ) __attribute__((section(".ewram"))) __attribute__((target("thumb")));
